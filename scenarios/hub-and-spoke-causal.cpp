...
NS_LOG_COMPONENT_DEFINE("ns3.ndn.vsync.scenarios.HASCO");
...
int main(int argc, char* argv[]) {
  ...
  for (int i = 1; i <= N; ++i) {
    ndn::AppHelper helper("ns3::ndn::vsync::SimpleCOApp");
  ...
  std::string file_name = "HASCO-D" + LinkDelay + "N" + std::to_string(N);
